...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SECTION 1: Session 18 Review
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Review: Session 18 -- JSON and API REST}

\begin{frame}[fragile]
\frametitle{What We Learned in Session 18 (1/3)}

\textbf{JSON format}: a standard for managing \textbf{structured data}.

\begin{itemize}
\item \textbf{Objects}: defined with curly brackets \texttt{\{\}}
\item \textbf{Arrays}: defined with brackets \texttt{[]}
\item \textbf{Fields}: key-value pairs (\texttt{"name": "value"})
\end{itemize}
...
\begin{frame}[fragile]
\frametitle{What We Learned in Session 18 (2/3)}

\textbf{Reading JSON from Python} using the \pythoninline{json} library:
...
\begin{itemize}
\item \pythoninline{json.loads()}: converts a JSON \textbf{string} into a Python \textbf{dictionary}
\item Access fields using \textbf{dictionary keys}
\end{itemize}

\end{frame}

\begin{frame}[fragile]
\frametitle{What We Learned in Session 18 (3/3)}

\textbf{API REST}: web servers can provide \textbf{objects} (not just HTML) to applications using HTTP.

\vspace{0.2cm}

\textbf{HTTP client} with \pythoninline{http.client}:
...
\begin{itemize}
\item Server returns data in \textbf{JSON format} (\texttt{Content-Type: application/json})
\item Client \textbf{parses} the JSON response into Python objects
\end{itemize}
